            ...
            <div className="container marginbottom-50">
              <div className="col-sm-12">
                ...
                <div className="form-group col-sm-3">
                  ...
                  <br />
                  <select id="source" name="source" className="form-control" required value={source} onChange={handleSourceChange}>
                ...
                <div className="form-group col-sm-3">
                  ...
                  <br />
                  <select id="destination" name="destination" className="form-control" required value={destination} onChange={handleDestinationChange}>
