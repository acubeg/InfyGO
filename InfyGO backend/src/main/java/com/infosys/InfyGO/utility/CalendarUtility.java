...
public class CalendarUtility {
    ...
    public static Calendar getCalendarFromString(String date) throws InfyGoBootException, ParseException {
     ...
     */
    public static String getStringFromCalendar(Calendar calendar) throws InfyGoBootException {
